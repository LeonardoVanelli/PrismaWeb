...
namespace PrismaWEB.Controllers
{
    public class StatusController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Nome,Descricao")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Nome,Descricao")] Status status)
        {
            if (ModelState.IsValid)
            {
